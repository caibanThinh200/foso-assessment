...
const BlogContent = () => {
  return (
    <div className="flex flex-col gap-5">
      <h2 id="1" className="text-green font-bold text-xl">1. Quy trình 5S là gì ?</h2>
      ...
      <ul className="list-disc flex flex-col gap-2 pl-10">
        <li className="text-green">
          Seiri <span className="text-raison-black">(Ngăn nắp)</span>
        </li>
        <li className="text-green">
          Seiso <span className="text-raison-black">(Sạch sẽ)</span>
        </li>
        <li className="text-green">
          Seiton <span className="text-raison-black">(Trật tự)</span>
        </li>
        <li className="text-green">
          Shitsuke <span className="text-raison-black">(Kỷ luật)</span>
        </li>
        <li className="text-green">
          Seiketsu <span className="text-raison-black">(Tiêu chuẩn hóa)</span>
        </li>
      </ul>
      <h2 id="2" className="text-green font-bold text-xl">
      ...
      <ImageWithNode
        src="/images/blog-thumbnail-2.png"
        note="Tại sao daonh nghiệp cần quy trình 5S?"
      />
      <h2 className="text-green font-bold text-xl">
      ...
      <p>
        ...
        các dụng cụ, thiết bị và tài liệu, giúp tiết kiệm thời gian và tăng năng
        suất làm việc.
      </p>
      <h3 className="text-base font-bold text-green">3.4 Tiết kiệm chi phí</h3>
      <p>
      ...
      <ImageWithNode
        ...
        note="Quy trình 5s gồm các bước"
      />
      <h2 className="text-green font-bold text-xl">
      ...
      <p>
        ...
        làm việc trong một tổ chức hoặc doanh nghiệp. 5S bao gồm năm bước cơ bản
        sau:
      </p>
      <h3 className="text-base font-bold text-green">4.1 Seiri (Ngăn nắp)</h3>
      <p>
      ...
      <h3 className="text-base font-bold text-green">4.2 Seiton (Sắp xếp)</h3>
      <p>
      ...
      <h3 className="text-base font-bold text-green">4.3 Seiso (Vệ sinh)</h3>
      <p>
      ...
      <h3 className="text-base font-bold text-green">4.5 Shitsuke (Kỷ luật)</h3>
      <p>
      ...
      <ImageWithNode
        src="/images/blog-thumbnail-4.png"
        note="Các bước thực hiện quy trình 5s"
      />
      <h2 className="text-green font-bold text-xl">
      ...
      <h3 className="text-base font-bold text-green">5.1 Giai đoạn chuẩn bị</h3>
      <p>
      ...
      <h3 className="text-base font-bold text-green">5.5 Đánh giá</h3>
      <p>
      ...
      <BlockQuote description="Về Kaizen, thì đây được xem là một triết lý cải tiến liên tục trong doanh nghiệp. Phương pháp này nhằm tạo ra sự thay đổi tích cực, mang tính liên tục và bền vững. " />
      <BlockQuote description="Còn đối với quy tắc 5S, đây là một phương pháp quản lý và cải tiến trong sản xuất. 5S tập trung vào việc sắp xếp, sạch sẽ, sắp đặt, tiêu chuẩn hóa và kỷ luật trong môi trường làm việc. " />
      <p>
        Tuy nhiên, quy trình 5S được xem là một phần của Kaizen. Và quy tắc này
        đóng vai trò quan trọng trong việc tạo ra môi trường làm việc sạch sẽ,
        an toàn. Quy tắc 5S thường được sử dụng làm bước đầu tiên trong quá
        trình cải tiến liên tục của phương pháp Kaizen để tạo ra một nền tảng
      ...
      <ImageWithNode
        src="/images/blog-thumbnail-5.png"
        note="Các yếu tố tạo nên thành công cho quy trình 5S"
      />
      <h2 className="text-green font-bold text-xl">
